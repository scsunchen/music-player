...
.atmo-gradient {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse at 35% 8%, rgba(245, 87, 108, 0.06) 0%, transparent 45%),
    radial-gradient(ellipse at 65% 90%, rgba(var(--dynamic-r), var(--dynamic-g), var(--dynamic-b), 0.04) 0%, transparent 40%),
...
.atmo-orb {
  position: absolute;
  border-radius: 50%;
  box-shadow: 0 0 100px 30px rgba(245, 87, 108, 0.06);
